            ...
            <div class="row">
                    ...
                    <div class="card booking-card">
                        ...
                        <div class="card-body">
                            <div class="row pagination">
                                <input type="hidden" value="{{ $i = 1 }}" id="data" grade_id="{{ $grade_id }}"
                ...
                <div class="col-md-7 col-lg-9">
                    ...
                    <div class="card" id="table_data">
                        ...
                        <div class="card-body">
                            <input type="hidden" value="{{ $i = ($data->currentpage() - 1) * $data->perpage() + 1 }}"
                                id="example" current-page="{{ $data->currentpage() }}"
                                ...
                                <div class="info-widget">
                                    ...
                                    @foreach ($question_answer['answer'] as $answer)
                                        @if (Answer::where('question_id', $question_answer['id'])->where('correct_answer', 1)->count() > 1)
                                            <h5><input type="radio" value="{{ $answer['id'] }}"
                                                    class="sub_answer sub_answer_multiple" name="{{ $answer['id'] }}"
                                                    id="answer-{{ $answer['id'] }}"
                                                    question-id="{{ $question_answer['id'] }}" key="{{ $i }}"
