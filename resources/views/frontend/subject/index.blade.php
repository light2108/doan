                                            ...
                                            @foreach ($subject_exams as $subject_exam)
                                                @if (in_array(Auth::guard('student')->user()->class_id, explode(',', $subject_exam['class_id'])))
                                                    <tr>
                                                        ...
                                                        <td>{{(!empty($subject_exam['time'])?$subject_exam['time']:(int)(date('Y-m-d H:i:s', strtotime($subject_exam['end_time']))-date('Y-m-d H:i:s', strtotime($subject_exam['start_time']))))}}</td>
                                                        ...
                                                        @if(date('Y-m-d H:i:s', strtotime($subject_exam['start_time']))<=date('Y-m-d H:i:s', strtotime(Carbon::now())))
                                                            ...
                                                            @endif
                                                        @else
                                                            <a class="btn btn-sm bg-info-light" href="{{url('/exam/subject/'.$subject_exam['subject_id'].'/grade/'.$subject_exam['grade_id'])}}"><i
                                                                class="far fa-eye"></i>
                                                            Enter Exam</a>
                                                        @endif
                                                        </td>
